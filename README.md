...
- Fixed a room clean (or spot clean) requested while already cleaning or
  paused raising a raw `-3001`/`-3002` device error (or, briefly, being
  silently dropped) — now raises a clear, human-readable error instead
