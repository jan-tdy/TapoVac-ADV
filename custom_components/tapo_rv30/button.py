"""Button entities for Omni dock actions — EXPERIMENTAL, see README "Dock
support (Omni)". Only created for the specific actions the device's
firmware confirms it has (coordinator.dock_features, probed once at
startup via TapoVacuumClient.get_dock_features) — a plain RV30/RV20
without a dock gets none of these entities at all."""
